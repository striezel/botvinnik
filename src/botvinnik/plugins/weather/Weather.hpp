...
#ifndef BVN_PLUGIN_WEATHER_HPP
#define BVN_PLUGIN_WEATHER_HPP
...
/** \brief Gets weather data for a given location.
 */
class Weather final: public DeactivatablePlugin
{
  public:
