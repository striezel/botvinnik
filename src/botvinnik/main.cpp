...
int main(int argc, char** argv)
{
  ...
  */
  ...
  {
    // Should never happen!
    std::cerr << "Error: Registration of basic plugin failed!\n"
  ...
  {
    // Should never happen!
    std::cerr << "Error: Registration of help plugin failed!\n"
              << "The bot will not start.\n";
    return bvn::rcPluginRegistrationError;
  }
  ...
  {
    // Should never happen!
    std::cerr << "Error: Registration of rooms plugin failed!\n"
              << "The bot will not start.\n";
    return bvn::rcPluginRegistrationError;
  }
  bvn::Wikipedia wiki;
  ...
  {
    // Should never happen!
    std::cerr << "Error: Registration of wiki plugin failed!\n"
              << "The bot will not start.\n";
    return bvn::rcPluginRegistrationError;
  }
  ...
  {
    // Should never happen!
    std::cerr << "Error: Registration of ping plugin failed!\n"
              << "The bot will not start.\n";
    return bvn::rcPluginRegistrationError;
  }
  #if defined(__linux__) || defined(linux)
  ...
  {
    // Should never happen!
    std::cerr << "Error: Registration of fortune plugin failed!\n"
              << "The bot will not start.\n";
    return bvn::rcPluginRegistrationError;
  }
  #endif
  ...
  {
    // Should never happen!
    std::cerr << "Error: Registration of xkcd plugin failed!\n"
              << "The bot will not start.\n";
    return bvn::rcPluginRegistrationError;
  }
  bvn::Debian deb;
  ...
  {
    // Should never happen!
    std::cerr << "Error: Registration of conversion plugin failed!\n"
              << "The bot will not start.\n";
    return bvn::rcPluginRegistrationError;
  }
  ...
  {
    // Should never happen!
    std::cerr << "Error: Registration of cheat sheet plugin failed!\n"
              << "The bot will not start.\n";
    return bvn::rcPluginRegistrationError;
  }
  ...
  {
    // Should never happen!
    std::cerr << "Error: Registration of translate plugin failed!\n"
              << "The bot will not start.\n";
    return bvn::rcPluginRegistrationError;
  }
  ...
  {
    // Should never happen!
    std::cerr << "Error: Registration of Giphy plugin failed!\n"
              << "The bot will not start.\n";
    return bvn::rcPluginRegistrationError;
  }
  bvn::Weather weather;
  ...
  {
    // Should never happen!
    std::cerr << "Error: Registration of weather plugin failed!\n"
              << "The bot will not start.\n";
    return bvn::rcPluginRegistrationError;
  }
